        ...
        let board = null;
        const obstaclesInput = document.getElementById("id_obstacles_json")
        const lidarXInput = document.getElementById("id_lidar_x");
        const lidarYInput = document.getElementById("id_lidar_y");
                    ...
                    cellGroup.attr({
                        ...
                        if(obstacle == undefined) {
                            ...
                            if(obsType == "circle" || obsType == "square") {
                                ...
                                lidarXInput.value = cell.x * realCellSize;
                                lidarYInput.value = cell.y * realCellSize;
                            }
                        }
                        board.lidar.toFront();
                    });
        ...
        function pushDataToInputs() {

            obstacles = [];
            board.obstacles.forEach( function (value) {
                obstacles.push(value);
            });
            data = JSON.stringify(obstacles);
            obstaclesInput.value = data;
        }
